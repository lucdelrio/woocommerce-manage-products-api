...
module ZecatApi
  class Products < ZecatApi::Base
    class << self
      ...
      # Generic Variant
      # product_list = ZecatApi::Products.get_generic_product_by_family_with_pages('64', '2', '5')
      # list = product_list.dig('generic_products')
      # Ropa
      # ZecatApi::Products.get_generic_product_by_family_with_pages('128', '1', '5')
